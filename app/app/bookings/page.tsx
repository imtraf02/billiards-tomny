...
import { Calendar as CalendarIcon, Filter, Download, History, ChevronLeft, ChevronRight } from "lucide-react";
...
import { BookingDetailDialog } from "@/features/booking/components/booking-detail-dialog";
        ...
        <>
            ...
            <Main fixed>
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">Lịch sử phiên chơi</h1>
                    ...
                    <div className="flex flex-col gap-3 p-4 bg-muted/30 rounded-lg border sm:flex-row sm:items-center">
                        ...
                        <div className="flex items-center gap-2">
                            <span className="text-xs text-muted-foreground mr-2">
                                Hiển thị {bookingsData?.data?.length || 0} / {bookingsData?.meta?.total || 0}
                            </span>
                        </div>
                    </div>
