            ...
            <CardContent className="space-y-3 pb-2">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5">
                        <div className={`h-2 w-2 rounded-full ${statusColors[booking.status]}`} />
                        <span className="text-xs font-medium">
                            {booking.status === "PENDING" ? "Đang chơi" : 
                             booking.status === "COMPLETED" ? "Đã thanh toán" : "Đã hủy"}
                        </span>
                    </div>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between pt-2 border-t">
                        <span className="text-sm font-semibold text-muted-foreground">Tổng tiền:</span>
