...
export function TableSessionDialog({
	...
	const { data: activeBooking, isLoading: isLoadingDetail } = useGetBooking(
						...
						<div className="space-y-3">
							<div className="flex items-center justify-between">
								...
								<Button
									variant="outline"
									size="sm"
									onClick={() => onOpenOrder(activeBooking.id)}
								>
							...
							{activeBooking &&
							(activeBooking as any).orders &&
							(activeBooking as any).orders.length > 0 ? (
							...
							{activeBooking &&
								...
								(activeBooking as any).orders.length > 0 && (
									<div className="flex justify-between text-sm">
										...
										<span className="font-medium">
											{new Intl.NumberFormat("vi-VN").format(
												(activeBooking as any).orders.reduce(
