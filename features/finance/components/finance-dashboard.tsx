				...
				<TabsContent value="overview" className="space-y-6">
					...
					<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
						...
						<Card>
							...
							<CardContent>
								<div
									className={`text-2xl font-bold ${(financialData?.profit || 0) >= 0 ? "text-green-600" : "text-red-600"}`}
								>
									{isLoading
										? "..."
						...
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">
									{isLoading
										? "..."
										: formatCurrency(financialData?.totalDebt || 0)}
								</div>
								<p className="text-xs text-muted-foreground">
				...
				<TabsContent value="profit" className="space-y-6">
					<Card>
						<CardHeader>
							...
							<CardDescription>Chi tiết lãi/lỗ từng sản phẩm</CardDescription>
						</CardHeader>
						<CardContent>
							<ProfitProductChart
								...
								<div className="space-y-4">
									{financialData?.profitByCategory?.map((item: any) => (
										...
										>
											...
											<span
												className={`font-medium ${item.profit >= 0 ? "text-green-600" : "text-red-600"}`}
											>
