...
export function ProfitProductChart({ data, showDetails = false }: ProfitProductChartProps) {
                ...
                <BarChart data={chartData}>
                    ...
                    <Tooltip 
                        formatter={(value, name) => {
                            ...
                            return [formatted, name === 'profit' ? 'Lợi nhuận' : name === 'revenue' ? 'Doanh thu' : 'Chi phí'];
                        }}
                    />
                    {showDetails ? (
                        <>
