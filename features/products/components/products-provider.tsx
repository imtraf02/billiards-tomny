...
type ProductsContextType = {
	...
	currentRow: ProductDetails | null;
	setCurrentRow: React.Dispatch<React.SetStateAction<ProductDetails | null>>;
};
...
export function ProductsProvider({ children }: { children: React.ReactNode }) {
	...
	const [currentRow, setCurrentRow] = useState<ProductDetails | null>(null);
